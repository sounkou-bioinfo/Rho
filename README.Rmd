...
abstractions: S7 dispatch for open protocols, nanonext for I/O, and mirai for
worker evaluation.**
...
The probe is also available as a script. It prints model, status, answer, and
event count, never credential material:
...
separate installable packages. Each package README below contains an example
that is executed when the documentation is rendered.
...
green package checks, live-provider probes, documentation, and secret scanning.
