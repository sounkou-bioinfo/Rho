...
```{r source-cancellation-settles-continuation}
...
```{r continuation-cancels-active-child}
...
```{r all-rejection-cancels-siblings}
...
```{r cancelling-queued-entry-preserves-active-entry}
queue <- rho_serial_queue()
