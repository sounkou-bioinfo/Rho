...
[`rho.compute`](https://rgenomicsetl.github.io/Rho/rho.compute/) adapts
mirai worker evaluation to
...
[`rho.graphics`](https://rgenomicsetl.github.io/Rho/rho.graphics/) uses
the same backend to render away from the interactive device. See the
[`rho.compute`
